...
final class Cron_Model {
	...
	public static function add_cron_hooks() {
		...
		add_filter( 'cron_schedules', [ '\wpbuddy\rich_snippets\Cron_Model', 'add_cron_schedules' ] );

		add_action( 'wpbuddy/rich_snippets/cron/2weeks', [ '\wpbuddy\rich_snippets\Cron_Model', 'run_2weeks_cron' ] );
	}
