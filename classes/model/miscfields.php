...
final class MiscFields_Model {
	...
	public static function get_5_star_rating_html( $args ) {
		...
		$input_name .= $args['property']->overridable_multiple && 'overwrite' === $args['screen'] ? '[]' : '';
	 ...
	 * @return string
	 */
	public static function misc_rating_5_star( $val, Rich_Snippet $rich_snippet, array $meta_info ) {
	 ...
	 * @return string
	 */
	public static function misc_rating_100_points( $val, Rich_Snippet $rich_snippet, array $meta_info ) {
